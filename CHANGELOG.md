...
- Crate `simple-lector-dni-tauri` con la sesión en hilo, los eventos `progress`/`read`/`session_ended`, ajustes JSON y secretos en el llavero, compartida por la app de escritorio y por apps privadas.
