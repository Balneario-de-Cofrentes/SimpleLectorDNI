...
Este inventario corresponde a las dependencias Rust resueltas en `Cargo.lock` para SimpleLectorDNI 0.1.0. Las expresiones de licencia proceden de los metadatos publicados por cada paquete. Los textos legales conservados por Cargo y por los proyectos de origen siguen siendo la referencia aplicable.

| Paquete | Versión | Licencia declarada | Origen |
|---|---:|---|---|
...
| atomic-write-file | 0.3.1 | BSD-3-Clause | https://github.com/andreacorbellini/rust-atomic-write-file |
